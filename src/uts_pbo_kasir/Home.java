    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        // TODO add your handling code here:
         if ("".equals(id.getText()) || "".equals(Hrg_mkn.getText()) || "".equals(Hrg_mnm.getText()) || "".equals(bayar.getText()) || kembali.equals("") || "".equals(total.getText())) {
            ...
            String SQL = "INSERT INTO tb_harga (id_kasir_makanan_hrg_makan,minuman,hrg_minum,bayar,kembali,total) " + "VALUES('"+id.getText()+"','"+kasir.getText()+"','"+makan.getText()+"','"+Hrg_mkn.getText()+"','"+minum.getText()+"','"+Hrg_mnm.getText()+"','"+bayar.getText()+"','"+kembali.getText()+"','"+total.getText()+"')";                    
       ...
       String kolom[] = {"ID","Kasir","Makanan","Harga Makanan","Minuman","Harga Minuman","Bayar","Kembali","Total"};
        ...
        try
        {
            ...
            while(rs.next())
            {
                ...
                String data[] = {id,kasir,makanan,hrg_makan,minuman,hrg_minum,bayar,kembali,total};
                dtm.addRow(data);
            }
        }
